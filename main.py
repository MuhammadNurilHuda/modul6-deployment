...
def predict():
    ...
    model_dict = {'manual' : 'static/Model/model_heroku.h5',
                    # 'resnet' : 'static/Model/model_resnet_diabet.h5',
                  'deployment' :   'static/Model/model.h5',}
...
def predict_result(model, run_time, probs, img):
    class_list = {'Negatif': 0, 'Positif': 1}
